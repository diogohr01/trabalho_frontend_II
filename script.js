...
const tesoura = document.getElementById('opçãoTesoura');
 const valorcomputador = document.getElementById('pontosComputador')
const valorusuario = document.getElementById('pontosUsuário')
...
function game(escolhaJogador, escolhacomputador) {
    ...
    if (escolhaJogador = 1 && escolhacomputador == 3) {
        ...
        document.querySelector('.resultado > p').innerText = 'Você ganhou!';
    } else if (escolhaJogador = 1 && escolhacomputador == 2) {
        machineWin = machineWin + 1;
        document.querySelector('.resultado > p').innerText = 'Você perdeu!';
    } else if (escolhaJogador = 1 && escolhacomputador == 1) {
        empate++;
        document.querySelector('.resultado > p').innerText = 'Empatou!';
    }
...
main();
valorcomputador.innerHTML = machineWin;
valorusuario.innerHTML = playerWin;
